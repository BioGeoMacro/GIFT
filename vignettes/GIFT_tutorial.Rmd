...
```{r, fig.label = "Figure 1. GIFT spatial", out.width = "100%", echo = FALSE}
...
```{r, fig.label = "Figure 2. Complete taxon", out.width = "100%", echo = FALSE}
...
```{r, fig.label = "Figure 3. Complete floristic", out.width = "100%", echo = FALSE}
...
```{r, fig.label = "Figure 4. No overlap", out.width = "100%", echo = FALSE}
knitr::include_graphics("../man/figures/GIFT_no_overlap.png")
```

```{r, fig.label = "Figure 5. Overlap threshold", out.width = "100%", echo = FALSE}
