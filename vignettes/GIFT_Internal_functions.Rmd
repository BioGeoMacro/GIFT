...
test <- DB_get_checklists_conditional(
  ...
  tax_group = 6,
  suit_geo = FALSE, # include checklists not marked as having complete
  # angiosperm list
...
# this gives the endemic/tree lists for entity that have both taxonomic
# and floristic suitable coverage
# but does not give the regions that do not have good coverage of
# taxonomic/floristic 
```
...
# germany_checklists <- regions[grep("Germany", regions$geo_entity), ]
```
