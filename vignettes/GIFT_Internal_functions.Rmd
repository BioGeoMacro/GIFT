...
argument allows for retrieving different isntances of the GIFT database and
...
in each instance, we can also map this difference.
...
# 9. Overlap_GloNAF tables (and others)
