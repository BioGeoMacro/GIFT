...
ggplot(world) +
  ...
  scale_color_gradientn(
    "Species number", trans = "log10", limits = c(1, 10000), 
    colours = RColorBrewer::brewer.pal(4, name = "Greens"),
    values = scales::rescale(log10(c(1, 10, 100, 1000, 10000))),
...
ggplot(world) +
  ...
  scale_color_gradientn(
    "Coverage (%)", 
    colours = rev(RColorBrewer::brewer.pal(9, name = "YlGnBu")),
    limits = c(0, 100),
    na.value = "transparent") +
  scale_fill_gradientn(
    "Coverage (%)", 
