...
<br>
<br>
Following arguments of `GIFT_checklists()` relate to the floristic statuses of
...
set to `TRUE`. In that case, the `GIFT_checklists()` will either retrieve the
...
Now that we covered the main arguments of `GIFT_checklists()`, we can retrieve
plant checklists for the Mediterranean region. `GIFT_checklists()` returns a
...
We see here that the region El Hierro has an average altitude of 579 meters
above sea level and an average annual temperature of 21.6 Celsius degrees. 
