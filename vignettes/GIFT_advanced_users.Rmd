...
unique(ex2$lists$ref_ID)[!(unique(ex2$lists$ref_ID) %in%
                             unique(ex3$lists$ref_ID))]
```

If we look at the `ref_ID = 10143`, we see that it is a checklist for the 
Pilbara region in Australia. Its `entity_ID` is 10043. Looking at the GIFT
